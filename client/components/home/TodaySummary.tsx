...
export const TodaySummary: React.FC<TodaySummaryProps> = ({
  ...
  return (
    <div className="w-full h-39 bg-[#FFFCF2] rounded-t-xl relative">
      ...
      <div className="absolute left-5.5 top-16 w-15 h-17 bg-[#DCEAEB] rounded-full flex items-center justify-center"></div>
      ...
      <div className="absolute left-24.5 top-19 w-56 h-10">
        ...
        <div className="absolute right-2 top-8 flex gap-1">
          {/* Sad face */}
          <div className="w-3 h-2 text-xs flex items-center justify-center">
            🙁
          </div>
          {/* Happy face */}
          <div className="w-3 h-2 text-xs flex items-center justify-center">
