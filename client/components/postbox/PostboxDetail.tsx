...
export const PostboxDetail: React.FC = () => {
  ...
  const getProgressBarColor = (type: 'stress' | 'resilience' | 'emotionalStability') => {
    switch (type) {
      case 'stress':
            ...
            <div className="flex-1 flex items-center gap-2">
              <div className="flex-1 relative">
                ...
                <div 
                  ...
                  style={{ width: `${(selectedLetter.emotionScore / 100) * 100}%` }}
                ></div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 relative mr-4">
                  ...
                  <div 
                    ...
                    style={{ width: `${selectedLetter.emotionalAnalysis.stress}%` }}
                  ></div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 relative mr-4">
                  ...
                  <div 
                    ...
                    style={{ width: `${selectedLetter.emotionalAnalysis.resilience}%` }}
                  ></div>
                </div>
                <span className="text-black font-pretendard text-base font-normal leading-normal tracking-tight">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 relative mr-4">
                  ...
                  <div 
                    ...
                    style={{ width: `${selectedLetter.emotionalAnalysis.emotionalStability}%` }}
                  ></div>
                </div>
                <span className="text-black font-pretendard text-base font-normal leading-normal tracking-tight">
