...
const mockReports: WeeklyReport[] = [
  {
    ...
    insights: '이번 주는 전반적으로 안정적인 감정 상태를 유지하셨습니다. 스트레스 수준이 평균보다 낮고, 회복 탄력성이 향상되었습니다.',
    aiRecommendations: '계속해서 규칙적인 생활 패턴을 유지하시고, 감정 기록을 통해 자신의 변화를 관찰해보세요. 스트레스 관리를 위해 명상이나 가벼운 운동을 추천합니다.',
  ...
  },
  {
    ...
    insights: '이번 주는 특히 회복 탄력성이 높았습니다. 어려운 상황에서도 긍정적으로 대처하는 모습을 보였습니다.',
    aiRecommendations: '현재의 긍정적인 마인드를 유지하세요. 어려운 일이 있어�� 차근차근 해결해 나가는 능력이 있습니다.',
  ...
  },
  {
    ...
    insights: '새해 시작과 함께 약간의 스트레스가 있었지만, 점차 적응해 가는 모습입니다.',
    aiRecommendations: '새로운 환경에 적응하는 시간을 가지세요. 천천히 하루하루 기록하며 변화를 관찰해보세요.',
